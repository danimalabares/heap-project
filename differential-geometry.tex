...
\begin{exercise}
\label{exercise-jacobi-nonpositive-k}
\begin{reference}
...
\noindent
Proposition
\ref{proposition-exp-nonpositive-curvature-expanding}
is the main tool
to prove Hadamard's theorem. It
is basically an application
of Rauch's Theorem \ref{theorem-rauch-clean}.
...
at hand, we use 
Proposition 
\ref{proposition-local-diffeomorphism-covering}
...
\begin{proposition}
\label{proposition-local-diffeomorphism-covering}
\begin{reference}
...
\begin{theorem}[Rauch]
\label{theorem-rauch-comparison}
...
\begin{remark}
\label{remark-rauch-comparison-notation}
...
\begin{remark}
\label{remark-jacobi-orthogonality-initial}
...
\begin{remark}
\label{remark-rauch-real-jacobi-equation}
...
Rauch's theorem \ref{theorem-rauch-comparison} to
...
\ref{theorem-rauch-comparison} para comparar esse campo
com $\tilde{J}$,
