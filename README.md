...
1. PDF viewer: [Sioyek](https://sioyek.info/)
2. [Using Vim keyboard shortcuts in Chrome](https://chromewebstore.google.com/detail/vimium/dbepggeogbaibhgnhhndojpepiihcmeb?hl=en&pli=1) to facilitate navigation:
3. Shell for Mac OS: [Oh My SSH](https://ohmyz.sh/)
