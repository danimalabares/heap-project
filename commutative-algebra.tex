...
$A \to M$, $a \mapsto ax$
and so $M=A/\Ker$.
So cyclcic modules are quotients of
the ring by an ideal.

\begin{lemma}[Nakayama]
\label{lemma-nakayama-cyclic}
$M$ finitely generated $A$-module
$\mathfrak{a} \subset A$ an ideal,
$\mathfrak{a}M\subset M$.
Then there exists $a \in \mathfrak{a}$
such that
$$
(1-a)M=M.
$$
