...
by the quotient projections. In particular
they are embeddings because the quotient
identifications only pair points
coming from different $X_i$.
...
\mathcal{O}_X(U)
:=
(\bigoplus \mathcal{O}_{X_i}(U \cap X_i))
/\sim
$$
(since coproduct in the category
of rings is direct sum, a fact
