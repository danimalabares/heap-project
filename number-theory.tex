...
\begin{lemma}
\label{lemma-ring-polyn-one-indet-over}
...
polynomial rings]
\label{theorem-eucli-algor-polyn-rings}
...
\begin{exercise}
\label{exercise-gaussian-integers-euclidean}
...
?
\end{proof}
\section{Unique factorization domains and the
Gauss lemma}
\label{section-UFD}
...
\begin{lemma}
\label{lemma-relat-prime-divid-impli-divid}
...
\begin{proof}
By Theorem
\ref{theorem-Bachet-Bezout-for-integers},
...
polynomials]
\label{theorem-divis-algor-polyn}
\begin{reference}
...
\begin{theorem}[Bachet-Bézout for polynomials
over field]
\label{theorem-bache-bezou-polyn-over-fiel}
\begin{reference}
...
Now suppose that $d=1$. Then by Bachet-Bézout
Theorem
\ref{theorem-bache-bezou-polyn-over-fiel}
...
by Lemma
\ref{lemma-irreducible-is-prime-in-F[x]}.
...
\begin{lemma}
\label{lemma-ufd-irred-eleme-gener-prime}
...
\begin{lemma}
\label{lemma-primi-part-uniqu-up-unit}
...
\begin{lemma}
\label{lemma-irred-fx-impli-primi-part}
...
\ref{definition-primitive-part} we obtain
...
By Lemma
\ref{lemma-irred-fx-impli-primi-part} each of
the
...
of Gauss lemma \ref{lemma-Gauss}: after
