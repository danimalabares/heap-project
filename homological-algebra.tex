...
\begin{exercise}
\label{exercise-homca}
Check that $\Hom(C,A)$…
\end{exercise}

\begin{remark}
\label{remark-tensor-g-modules}
...
Equation \ref{equation-ses-gmod},
$$
\Hom_{\mathbb{F}}(C,A)
\simeq
C^* \otimes A,
...
\begin{theorem}
\label{theorem-extensions-cohomology}
$\psi$ is a bijection
...
\begin{lemma}[Corollary]
\label{lemma-g-modules-ses-split}
...
\label{section-spectral-sequences}
...
$$
\begin{equation}
\label{equation-differential-spectral}
\begin{aligned}
...
\begin{lemma}
\label{lemma-chevalley-eilenberg-acyclic}
...
\begin{theorem}
\label{theorem-spectral-sequence}
...
\begin{remark}
\label{remark-spectral-sequence}
\begin{enumerate}
...
section, namely
Lemma
\ref{lemma-chevalley-eilenberg-acyclic}.
...
as defined in
Equation
\ref{equation-differential-spectral}.
...
\begin{equation}
\label{equation-differential-koszul}
\begin{aligned}
...
Equation \ref{equation-differential-koszul}.
...
\begin{proposition}
\label{proposition-homology-tensor-koszul}
...
\begin{proposition}
\label{proposition-koszul-polynomials}
...
\begin{lemma}[Corollary]
\label{lemma-homology-koszul-polynomials}
...
\label{section-cone-construction}
...
\begin{proposition}
\label{proposition-ses-complexes-cone}
...
Recall Theorem \ref{theorem-balancing}.
...
\begin{lemma}[Acyclic assembly lemma,
homological version]
\label{lemma-assembly-homological}
...
\label{section-resolution-by-acyclic}
...
\label{section-simplicial-homology}

\begin{definition}
\label{definition-n-simplex}
...
\begin{definition}
\label{definition-abstract-simplicial-cx}
...
\begin{example}
\label{example-triangulate-s1}
Triangulate $S^1$ by 1-simplices.
[Figure of circle with three points…]
\end{example}

\begin{definition}
\label{definition-geometric-realization}
Let $K$ be an ASC.
...
\begin{definition}
\label{definition-asc-n-simplex}
...
\begin{definition}
\label{definition-simplicial-homology}
...
\begin{remark}
\label{remark-delta-sets-vs-simplicial-sets}
...
\begin{definition}
\label{definition-homology-complex}
...
and
$$
\delta \langlev_0,\dots,v_p\rangle
=
\sum_{i=0}^p (-1)^i
\langle
...
\begin{definition}
\label{definition-big-delta-set}
...
\begin{remark}
\label{remark-big-delta-set-simplicial-set}
