...
Hodge locus
(see Definition
\ref{definition-generic-mt-group}).
...
groups}
\label{section-hodge-struc-mumfo-tate-grou}
\label{section-mt-hodge-structures}
...
representations}
\label{section-reduc-group-their-repre}
...
\begin{theorem}
\label{theorem-reduc-group-repre}
...
\noindent
Equation \ref{equation-diagram} defines a
$K[G]$-comodule
structure on $K[G]$.
...
varieties}
\label{section-hodge-struc-abeli-varie}
...
$$
Then $V_\mathbb{R}^+=\left<e,f\right>$ --- an
orthonormal basis,
$Cl^0(V_\mathbb{R}^+)=\left<1,ef\right>\simeq
\mathbb{R}^2$.
