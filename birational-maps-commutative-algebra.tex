...
\title{Birational maps from the commutative
algebra viewpoint}
\maketitle
...
varieties}
\label{section-ratio-maps-proje-varie}
...
for all $i \geq d$,
$A_d=F\left<a_1,…,a_e\right>$.
Show that $K(A)= F
\left<\frac{a_1}{a_1},…,\frac{a_e}{a_1}
\right>$
(exercise).
\end{proof}
...
\begin{theorem}
\label{theorem-jacob-rank-birat}
