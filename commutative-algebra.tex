...
\begin{enumerate}
\item We say $R \to S$ is of {\it finite type}, 
or that {\it $S$ is a finite
type $R$-algebra} if there exist an $n \in \mathbf{N}$ 
and a surjection
...
(it was in the lectures but
the result is not here) explain
...
namely Theorem \ref{theorem-artinian-
semisimple-is-direct-sum-of-fields}.
...
\begin{exercise}
\label{exercise-subalgebra-generated-by-indecomposable-is-field}
...
\begin{exercise}
\label{exercise-decomposition-of-unity-in-orthogonal-idempotents}
...
\begin{exercise}
\label{exercise-artinian-ring-is
...
\begin{proof}
This is just
Exercises \ref{exercise-decomposition-of-unity-in-orthogonal-idempotents}
and \ref{exercise-artinian-without-idempotents-is-field}.
\end{proof}

\begin{exercise}
\label{exercise-artinian-algebra
-decomposition-in-char2}
...
see Exercise
\ref{exercise-artinian-without-idempotents-is-field}]
...
\section{Trace form}
\label{section-trace-form}

\noindent
It's not yet clear why do we need the
trace form for.
...
\begin{theorem}
\label{theorem-nondegenerate-trace-semisimple}
