...
namely Theorem \ref{theorem-semisimple-decomposition}.
...
Namely,
Theorem
\ref{theorem-nondegenerate-trace-semisimple}
...
space over $\mathbb{C}$.
By Theorem \ref{theorem-semisimple-decomposition},
...
\noindent
We also define {\it birational morphism} if
the induced map on fraction fields is an
isomorphism, and further show:
...
(recall that being noetherian is the same
as…). As for the second, express $x^n$ as an
element of the finitely-generated module.
For the converse of the last equivalence
we use division algorithm on the
minimal polynomial to kill any residue,
and thus the minimal polynomial divides
any other polynomial in the algebra
