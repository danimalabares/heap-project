...
\label{section-lie-algebra-reps}
...
\begin{definition}
\label{definition-group-algebra}
...
\begin{theorem}
\label{theorem-representations-group-algebra}
...
\label{section-finite-group-reps}
...
\label{definition-finitely-generated-rep}
...
\begin{exercise}
\label{exercise-fg-c-t-inv-modules-z-reps}
...
\begin{exercise}
\label{exercise-z2-reps-fd-vs-all}
...
\begin{exercise}
\label{exercise-z2-reps-vs-vect}
Let $C_1$ be the category of all
finite-dimensional representations of
$\mathbb{Z}/2\mathbb{Z}$ over $\mathbb{C}$,
...
\begin{exercise}
\label{exercise-z2x-z2-vs-z4-reps}
Let $C_1$ be the category of all
finite-dimensional representations of
...
\begin{exercise}
\label{exercise-finite-groups-vs-abelian}
