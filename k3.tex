...
\noindent
Alright my progress on this
exercise (after 1 year and 5 months)
still has three black boxes:
\begin{enumerate}
\item Construction of normalization
from gluing affine pieces.
\item I know that the normalization map 
$\nu:\widetilde{C}\to C$
is finite by Noether normalization
(and gluing business, this I don't know
actually).
The black box is:
...
Theorem \ref{theorem-noether-normalization},
...
Commutative Algebra
Proposition
\ref{commutative-algebra-proposition-one-dimensional-dvr}
