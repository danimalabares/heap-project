...
Definition
\ref{definition-Cartan-subalgebra}) and
...
\label{section-basic-defin-examp}
...
\begin{example}
\label{example-assoc-algeb-gives-lie-algeb}
...
\label{theorem-cartan-semisimple}
...
\label{theorem-levi-decomposition}
\begin{reference}
...
Lie algebras}
\label{section-nilpo-solva-lie-algeb}
...
\begin{definition}
\label{definition-nilpo-solva-lie-algeb}
...
\label{section-gener-eigen-gener-weigh}
...
\begin{proposition}
\label{proposition-gener-eigen-decom}
...
\begin{theorem}
\label{theorem-decom-into-gener-weigh-spac}
...
$$
\begin{equation}
\label{equation-inclu-gener-repre}
...
\begin{definition}
\label{definition-gener-root-space-decom}
...
\begin{equation}
\label{equation-inclu-adjoi-repre}
[\mathfrak{g}_\alpha^\mathfrak{h},
...
\begin{exercise}
\label{exercise-gener-weigh-space-decom}
Take
...
\ref{equation-inclu-gener-repre} and
\ref{equation-inclu-adjoi-repre}.
\end{exercise}

\section{Zarisky Topology and Regular
Elements}
\label{section-zaris-topol-regul-eleme}
...
\begin{exercise}
\label{exercise-chara-polyn-ada}
...
\begin{proposition}
\label{proposition-diago-matri-carta-subal}
...
\begin{theorem}[Cartan]
\label{theorem-finit-dimen-lie-algeb-over}
Let $\mathfrak{g}$ be a finite-dimensional
Lie algebra over an
...
\begin{exercise}
\label{exercise-semis-iff-killi-nonde}
\begin{reference}
...
\begin{proposition}
\label{proposition-radic-ideal-conta-any}
...
\label{section-Borel-subalgebras}
...
\begin{definition}
\label{definition-Borel-subalgebra}
...
\begin{proposition}
\label{proposition-standard-Borel}
The Lie algebra
...
subalgebra.
\end{remark}
\section{Borel subalgebras of $\mathfrak{sl}_2$}
...
\mathcal B
=
\{\text{Borel subalgebras of }\mathfrak{sl}_2\}
\cong
\mathbb P^1.
$$
...
\begin{exercise}
\label{exercise-highe-weigh-irred-g-modul}
...
\begin{exercise}
\label{exercise-weyl-chara-formu-sl3}
