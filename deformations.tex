...
The deformation-theoretic meaning is particularly clear
for a one-parameter deformation
$$
\phi(t)=t\phi_1+t^2\phi_2+t^3\phi_3+\cdots.
$$
Substitution into the Maurer--Cartan equation gives at
first order
$$
\bar\partial\phi_1=0,
$$
while at second order it gives
$$
\bar\partial\phi_2
=-\frac12[\phi_1,\phi_1].
$$
Thus the bracket produces the first quadratic
obstruction: the first-order direction $\phi_1$ lifts
to second order only if
$\frac12[\phi_1,\phi_1]$ is $\bar\partial$-exact.
